...
------------- | ------------- | -------------
[**add_items_to_check**](OrdersApi.md#add_items_to_check) | **POST** /orders/v2/orders/{orderGuid}/checks/{checkGuid}/selections | Add items to a check
[**calculate_order_prices**](OrdersApi.md#calculate_order_prices) | **POST** /orders/v2/prices | Get order prices
[**create_order**](OrdersApi.md#create_order) | **POST** /orders/v2/orders | Post an order
[**get_multiple_orders**](OrdersApi.md#get_multiple_orders) | **GET** /orders/v2/ordersBulk | Get multiple orders
[**get_order_by_guid**](OrdersApi.md#get_order_by_guid) | **GET** /orders/v2/orders/{guid} | Get an order
[**list_order_identifiers**](OrdersApi.md#list_order_identifiers) | **GET** /orders/v2/orders | Get order identifiers (deprecated)
[**update_delivery_info**](OrdersApi.md#update_delivery_info) | **PATCH** /orders/v2/orders/{orderGuid}/deliveryInfo | Update delivery information
[**void_order**](OrdersApi.md#void_order) | **POST** /orders/v2/orders/{orderGuid}/void | Void an order


# **add_items_to_check**
> Order add_items_to_check(toast_restaurant_external_id, order_guid, check_guid, selection)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Add items to a check
        api_response = await api_instance.add_items_to_check(toast_restaurant_external_id, order_guid, check_guid, selection)
        print("The response of OrdersApi->add_items_to_check:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->add_items_to_check: %s\n" % e)
```
...
> Order calculate_order_prices(toast_restaurant_external_id, order)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get order prices
        api_response = await api_instance.calculate_order_prices(toast_restaurant_external_id, order)
        print("The response of OrdersApi->calculate_order_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->calculate_order_prices: %s\n" % e)
```
...
# **create_order**
> OrderResponse create_order(toast_restaurant_external_id, order)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Post an order
        api_response = await api_instance.create_order(toast_restaurant_external_id, order)
...
# **get_multiple_orders**
> List[Order] get_multiple_orders(toast_restaurant_external_id, start_date=start_date, end_date=end_date, business_date=business_date, page_size=page_size, page=page)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get multiple orders
        api_response = await api_instance.get_multiple_orders(toast_restaurant_external_id, start_date=start_date, end_date=end_date, business_date=business_date, page_size=page_size, page=page)
        print("The response of OrdersApi->get_multiple_orders:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->get_multiple_orders: %s\n" % e)
```
...
# **get_order_by_guid**
> Order get_order_by_guid(toast_restaurant_external_id, guid)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an order
        api_response = await api_instance.get_order_by_guid(toast_restaurant_external_id, guid)
        print("The response of OrdersApi->get_order_by_guid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->get_order_by_guid: %s\n" % e)
```
...
# **list_order_identifiers**
> List[str] list_order_identifiers(toast_restaurant_external_id, start_date=start_date, end_date=end_date, business_date=business_date)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get order identifiers (deprecated)
        api_response = await api_instance.list_order_identifiers(toast_restaurant_external_id, start_date=start_date, end_date=end_date, business_date=business_date)
        print("The response of OrdersApi->list_order_identifiers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->list_order_identifiers: %s\n" % e)
```
...
> Order update_delivery_info(toast_restaurant_external_id, order_guid, update_delivery_info_request)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    update_delivery_info_request = toastapi.UpdateDeliveryInfoRequest() # UpdateDeliveryInfoRequest | A JSON `deliveryInfo` object containing the delivery information you want to update for an order.  You can update the `deliveredDate`, `dispatchedDate`, `deliveryState`, or `DeliveryEmployee`.  These are the only values you can update with this endpoint. 

    try:
        # Update delivery information
        api_response = await api_instance.update_delivery_info(toast_restaurant_external_id, order_guid, update_delivery_info_request)
        print("The response of OrdersApi->update_delivery_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->update_delivery_info: %s\n" % e)
```
 ...
 **update_delivery_info_request** | [**UpdateDeliveryInfoRequest**](UpdateDeliveryInfoRequest.md)| A JSON &#x60;deliveryInfo&#x60; object containing the delivery information you want to update for an order.  You can update the &#x60;deliveredDate&#x60;, &#x60;dispatchedDate&#x60;, &#x60;deliveryState&#x60;, or &#x60;DeliveryEmployee&#x60;.  These are the only values you can update with this endpoint.  | 
