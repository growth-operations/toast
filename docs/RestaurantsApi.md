...
------------- | ------------- | -------------
[**get_restaurant_by_id**](RestaurantsApi.md#get_restaurant_by_id) | **GET** /restaurants/v1/restaurants/{restaurantGUID} | Get restaurant configuration information
[**list_restaurants_in_management_group**](RestaurantsApi.md#list_restaurants_in_management_group) | **GET** /restaurants/v1/groups/{managementGroupGUID}/restaurants | Get restaurants in a management group


# **get_restaurant_by_id**
> RestaurantInfo get_restaurant_by_id(restaurant_guid, toast_restaurant_external_id, include_archived=include_archived)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get restaurant configuration information
        api_response = await api_instance.get_restaurant_by_id(restaurant_guid, toast_restaurant_external_id, include_archived=include_archived)
        print("The response of RestaurantsApi->get_restaurant_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RestaurantsApi->get_restaurant_by_id: %s\n" % e)
```
...
# **list_restaurants_in_management_group**
> List[RestaurantBasic] list_restaurants_in_management_group(management_group_guid, toast_restaurant_external_id)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get restaurants in a management group
        api_response = await api_instance.list_restaurants_in_management_group(management_group_guid, toast_restaurant_external_id)
        print("The response of RestaurantsApi->list_restaurants_in_management_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RestaurantsApi->list_restaurants_in_management_group: %s\n" % e)
```
