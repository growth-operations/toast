...
------------- | ------------- | -------------
[**create_shift**](ShiftsApi.md#create_shift) | **POST** /labor/v1/shifts | Create a shift
[**delete_shift**](ShiftsApi.md#delete_shift) | **DELETE** /labor/v1/shifts/{shiftId} | Delete a shift
[**get_shift_by_id**](ShiftsApi.md#get_shift_by_id) | **GET** /labor/v1/shifts/{shiftId} | Get a shift
[**list_shifts**](ShiftsApi.md#list_shifts) | **GET** /labor/v1/shifts | Get shifts
[**update_shift**](ShiftsApi.md#update_shift) | **PUT** /labor/v1/shifts/{shiftId} | Update a shift


# **create_shift**
> Shift create_shift(toast_restaurant_external_id, content_type, body)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a shift
        api_response = await api_instance.create_shift(toast_restaurant_external_id, content_type, body)
        print("The response of ShiftsApi->create_shift:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShiftsApi->create_shift: %s\n" % e)
```
...
# **delete_shift**
> Shift delete_shift(toast_restaurant_external_id, shift_id)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a shift
        api_response = await api_instance.delete_shift(toast_restaurant_external_id, shift_id)
        print("The response of ShiftsApi->delete_shift:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShiftsApi->delete_shift: %s\n" % e)
```
...
# **get_shift_by_id**
> Shift get_shift_by_id(toast_restaurant_external_id, shift_id)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a shift
        api_response = await api_instance.get_shift_by_id(toast_restaurant_external_id, shift_id)
        print("The response of ShiftsApi->get_shift_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShiftsApi->get_shift_by_id: %s\n" % e)
```
...
# **list_shifts**
> List[Shift] list_shifts(toast_restaurant_external_id, shift_ids=shift_ids, start_date=start_date, end_date=end_date)
 ...
 **start_date** | **str**| Optional start date and time of time period to match  shifts. A shift matches the time period if the shift  &#x60;inDate&#x60; is after (inclusive) the specified &#x60;startDate&#x60; and  the shift &#x60;outDate&#x60; is before the &#x60;endDate&#x60; (exclusive).  These parameters are required if the &#x60;shiftIds&#x60; parameter  is not defined. The specified period cannot be longer than  one month.  | [optional] 
 **end_date** | **str**| Optional end date and time of time period to match shifts.  A shift matches the time period if the shift &#x60;inDate&#x60; is  after (inclusive) the specified &#x60;startDate&#x60; and the shift  &#x60;outDate&#x60; is before the &#x60;endDate&#x60; (exclusive). These  parameters are required if the &#x60;shiftIds&#x60; parameter is not  defined. The specified period cannot be longer than one  month.  | [optional] 
...
# **update_shift**
> Shift update_shift(toast_restaurant_external_id, shift_id, body)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a shift
        api_response = await api_instance.update_shift(toast_restaurant_external_id, shift_id, body)
        print("The response of ShiftsApi->update_shift:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShiftsApi->update_shift: %s\n" % e)
```
