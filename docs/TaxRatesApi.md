# toastapi.TaxRatesApi

All URIs are relative to *https://ws-sandbox-api.eng.toasttab.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_tax_rate_by_id**](TaxRatesApi.md#get_tax_rate_by_id) | **GET** /config/v2/taxRates/{guid} | Get tax rate by GUID
[**list_tax_rates**](TaxRatesApi.md#list_tax_rates) | **GET** /config/v2/taxRates | Get tax rates


# **get_tax_rate_by_id**
> TaxRate get_tax_rate_by_id(toast_restaurant_external_id, guid)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get tax rate by GUID
        api_response = await api_instance.get_tax_rate_by_id(toast_restaurant_external_id, guid)
        print("The response of TaxRatesApi->get_tax_rate_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxRatesApi->get_tax_rate_by_id: %s\n" % e)
```
...
# **list_tax_rates**
> List[TaxRate] list_tax_rates(toast_restaurant_external_id, limit=limit, page_token=page_token, last_modified=last_modified)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get tax rates
        api_response = await api_instance.list_tax_rates(toast_restaurant_external_id, limit=limit, page_token=page_token, last_modified=last_modified)
