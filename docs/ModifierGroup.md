...
**modifier_options** | [**List[ModifierOption]**](ModifierOption.md) | An array of &#x60;ModifierOption&#x60; objects that are contained in this modifier group. Modifier options are the individual selections available to a restaurant guest within a modifier group. For example, the modifier options in a \&quot;Pizza Toppings\&quot; modifier group might be pepperoni, mushrooms, or extra cheese.  | [optional] 
