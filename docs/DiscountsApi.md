...
------------- | ------------- | -------------
[**add_check_level_discounts**](DiscountsApi.md#add_check_level_discounts) | **POST** /orders/v2/orders/{orderGuid}/checks/{checkGuid}/appliedDiscounts | Add check-level discounts
[**add_item_level_discounts**](DiscountsApi.md#add_item_level_discounts) | **POST** /orders/v2/orders/{orderGuid}/checks/{checkGuid}/selections/{selectionGuid}/appliedDiscounts | Add item-level discounts
[**get_applicable_discounts**](DiscountsApi.md#get_applicable_discounts) | **POST** /orders/v2/applicableDiscounts | Get applicable discounts
[**get_discount_by_id**](DiscountsApi.md#get_discount_by_id) | **GET** /config/v2/discounts/{guid} | Get a discount
[**list_discounts**](DiscountsApi.md#list_discounts) | **GET** /config/v2/discounts | Get discounts


# **add_check_level_discounts**
> Order add_check_level_discounts(order_guid, check_guid, applied_discount)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Add check-level discounts
        api_response = await api_instance.add_check_level_discounts(order_guid, check_guid, applied_discount)
        print("The response of DiscountsApi->add_check_level_discounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountsApi->add_check_level_discounts: %s\n" % e)
```
...
# **add_item_level_discounts**
> Order add_item_level_discounts(order_guid, check_guid, selection_guid, applied_discount)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Add item-level discounts
        api_response = await api_instance.add_item_level_discounts(order_guid, check_guid, selection_guid, applied_discount)
        print("The response of DiscountsApi->add_item_level_discounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountsApi->add_item_level_discounts: %s\n" % e)
```
...
> List[ApplicableDiscount] get_applicable_discounts(toast_restaurant_external_id, applicable_discounts_request)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get applicable discounts
        api_response = await api_instance.get_applicable_discounts(toast_restaurant_external_id, applicable_discounts_request)
        print("The response of DiscountsApi->get_applicable_discounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountsApi->get_applicable_discounts: %s\n" % e)
```
...
# **get_discount_by_id**
> Discount get_discount_by_id(toast_restaurant_external_id, guid)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a discount
        api_response = await api_instance.get_discount_by_id(toast_restaurant_external_id, guid)
        print("The response of DiscountsApi->get_discount_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountsApi->get_discount_by_id: %s\n" % e)
```
...
# **list_discounts**
> List[Discount] list_discounts(toast_restaurant_external_id, page_token=page_token, last_modified=last_modified)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get discounts
        api_response = await api_instance.list_discounts(toast_restaurant_external_id, page_token=page_token, last_modified=last_modified)
        print("The response of DiscountsApi->list_discounts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountsApi->list_discounts: %s\n" % e)
```
