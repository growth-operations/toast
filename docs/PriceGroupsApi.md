...
------------- | ------------- | -------------
[**price_groups_get**](PriceGroupsApi.md#price_groups_get) | **GET** /config/v2/priceGroups | Get price groups
[**price_groups_guid_get**](PriceGroupsApi.md#price_groups_guid_get) | **GET** /config/v2/priceGroups/{guid} | Get price group by GUID


# **price_groups_get**
> List[PriceGroup] price_groups_get(toast_restaurant_external_id, limit=limit, page_token=page_token, last_modified=last_modified)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get price groups
        api_response = await api_instance.price_groups_get(toast_restaurant_external_id, limit=limit, page_token=page_token, last_modified=last_modified)
        print("The response of PriceGroupsApi->price_groups_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PriceGroupsApi->price_groups_get: %s\n" % e)
```
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get price group by GUID
        api_response = await api_instance.price_groups_guid_get(toast_restaurant_external_id, guid)
        print("The response of PriceGroupsApi->price_groups_guid_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PriceGroupsApi->price_groups_guid_get: %s\n" % e)
```
