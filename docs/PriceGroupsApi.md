# toastapi.PriceGroupsApi

All URIs are relative to *https://ws-sandbox-api.eng.toasttab.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_price_group_by_id**](PriceGroupsApi.md#get_price_group_by_id) | **GET** /config/v2/priceGroups/{guid} | Get price group by GUID
[**list_price_groups**](PriceGroupsApi.md#list_price_groups) | **GET** /config/v2/priceGroups | Get price groups


# **get_price_group_by_id**
> PriceGroup get_price_group_by_id(toast_restaurant_external_id, guid)

Get price group by GUID
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    api_instance = toastapi.PriceGroupsApi(api_client)
    toast_restaurant_external_id = 'toast_restaurant_external_id_example' # str | The identifier for the restaurant.
    guid = 'guid_example' # str | The GUID of the price group.

    try:
        # Get price group by GUID
        api_response = await api_instance.get_price_group_by_id(toast_restaurant_external_id, guid)
        print("The response of PriceGroupsApi->get_price_group_by_id:\n")
        pprint(api_response)
 ...
 **guid** | **str**| The GUID of the price group. | 
...
|-------------|-------------|------------------|
**200** | Returns a &#x60;PriceGroup&#x60; object. |  -  |
**404** | Price group not found. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **list_price_groups**
> List[PriceGroup] list_price_groups(toast_restaurant_external_id, limit=limit, page_token=page_token, last_modified=last_modified)
...
async with toastapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get price groups
        api_response = await api_instance.list_price_groups(toast_restaurant_external_id, limit=limit, page_token=page_token, last_modified=last_modified)
        print("The response of PriceGroupsApi->list_price_groups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PriceGroupsApi->list_price_groups: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Returns an array of &#x60;PriceGroup&#x60; objects. |  * Toast-Next-Page-Token - A string that identifies the following set of objects that the endpoint will return. You can use this value to retrieve that page of response data. To return the next page of objects you supply this value in the \&quot;pageToken\&quot; parameter of the next request to the endpoint. For more information, see https://doc.toasttab.com/doc/devguide/apiResponseDataPagination.html. <br>  |
